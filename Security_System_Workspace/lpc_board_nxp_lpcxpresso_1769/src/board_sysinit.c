...
STATIC const PINMUX_GRP_T pinmuxing[] = {
	{0,  5,   IOCON_MODE_INACT | IOCON_FUNC1},	/* m_pgm_c_1 */
	{2,  0,   IOCON_MODE_INACT | IOCON_FUNC2},	/* debug_txd */
	{2,  1,   IOCON_MODE_INACT | IOCON_FUNC2},	/* debug_rxd */
	//...Continue like this..
	//...Exactly use the names in the schematics PDF...
	//...Remove Unnecessary Items...
	//...Take Care about FUNCs...
